    ...
    const collaborations = [
        {
            ...
            with: "with Leila Ben Gacem, Yame Nkgowe, African Crossroads",
            year: "2021",
            url: "https://youtu.be/lQdGFakaacE"
        },
        {
            title: "La Grotte de Paul Ayhi",
            with: "with Pierrick Chabi - Pixpole",
            year: "2019"
        },
        {
            title: "Aux Impossibles Imminents !",
            with: "with Elom Vince (LOME+)",
            details: "Série de vidéos: Portraits de Loméens (Blacky, Mawuto, Yao, Kezita, Alex, Bertha)",
            year: "",
            url: "https://youtube.com/playlist?list=PL498F766A8DC2D6D5"
        }
    ];
