...
export default function Honor() {
    const honors = [
        {
            year: "2020",
            title: "AFRICA’S 50 DIGITAL CHAMPIONS",
            org: "Africa Digital Festival"
        },
        {
            year: "2020",
            title: "Best in Tech",
            org: "Première édition de la \"Africa List\" du magazine ESSENCE"
        },
        {
            year: "2019",
            title: "TOP Africa Innovators",
            org: "Sélectionné dans la cohorte Quartz 2019"
        },
        {
            year: "2018",
            title: "African Leadership Awards",
            org: "Paris"
        },
        {
            year: "2018",
            title: "Officier de l’Ordre National du Mérite",
            org: "République Togolaise"
        },
        {
            year: "2015",
            title: "NETEXPLO AWARDS",
            org: "Observatoire Netexplo de l’Innovation, UNESCO-Paris"
        },
        {
            year: "2014",
            title: "Global Fab Awards",
            org: "Prix reçu lors de FAB 10 à Barcelone par la Fab Foundation"
        },
        {
            year: "2013",
            title: "\"Best Mission Concept\"",
            org: "NASA International Space Apps Challenge"
        },
        {
            year: "2010",
            title: "Prix “Coeur d’Immobilier”",
            org: "Première place au concours pour le projet de la Maternité de Gao (Tchad)"
        }
    ];
        ...
        <div className="page-container">
            ...
            <p>Page in construction. Content will be added shortly.</p>
                        ...
                        <div className="images-grid-container">
                            <div className="grid-item"><img src="/images/honor_grid_1.jpeg" className="grid-img"/></div>
                            <div className="grid-item"><img src="/images/honor_grid_2.jpg" className="grid-img"/></div>
                            <div className="grid-item"><img src="/images/honor_grid_3.jpg" className="grid-img"/></div>
                        </div>
