    ...
    return (
        <div className="page-container">
            ...
            <div className="main-layout">
                <div className="left-column">
                    <div className="photo-container">
                        <Image
                            src="/images/edition_portrait.png"
                            alt="EDITION"
                            width={800}
                            height={800}
                ...
                <div className="right-column">
                    <div className="title-wrapper">
                        <h1 className="page-title">EDITION</h1>
                    </div>
                    ...
                    <div className="content-wrapper">
                        ...
                        <div className="edition-list">
                            <div className="book-item">
                                <h3 className="book-title">Décoloniser le Futur</h3>
                                <div className="book-details">
                                    <p>Essai</p>
                                    <p>Ed. L’Africaine</p>
                                    <p>Mai 2022</p>
                                    <p>(ISBN 978-2-9582205-2-5)</p>
                                </div>
                            </div>

                            <div className="book-item">
                                <h3 className="book-title">Girations</h3>
                                <div className="book-details">
                                    <p>Poésie</p>
                                    <p>Ed. L’Africaine</p>
                                    <p>Avril 2022</p>
                                    <p>(ISBN 978-2-9582205-1-8)</p>
                                </div>
                            </div>

                            <div className="book-item">
                                <h3 className="book-title">Le Centre de Flammes</h3>
                                <div className="book-details">
                                    <p>Poésie</p>
                                    <p>Ed. L’Africaine</p>
                                    <p>Avril 2022</p>
                                    <p>(ISBN 978-2-9582205-0-1)</p>
                                </div>
                            </div>
                        </div>
            ...
            <style jsx global>{`
                ...
                .book-details p { margin: 0 0 2px 0; line-height: 1.4; color: #000; font-size: 11px; }
