        ...
        <div className="page-container">
            ...
            <div className="main-layout">
                <div className="left-column">
                    <div className="photo-container">
                        <Image 
                            src="/images/publication_portrait.png" 
                            alt="PUBLICATIONS" 
                            width={800} 
                            height={800}
            ...
            <p>Page in construction. Content will be added shortly.</p>
                        ...
                        <div className="images-grid-container">
                            <div className="grid-item"><img src="/images/publication_grid_1.jpg" className="grid-img"/></div>
                            <div className="grid-item"><img src="/images/publication_grid_2.jpg" className="grid-img"/></div>
                            <div className="grid-item"><img src="/images/publication_grid_3.jpeg" className="grid-img"/></div>
                        </div>
