        ...
        <div className="page-container">
            ...
            <p>Page in construction. Content will be added shortly.</p>
                        ...
                        <div className="images-grid-container">
                            <div className="grid-item"><img src="/images/commitment_grid_1.jpg" className="grid-img"/></div>
                            <div className="grid-item"><img src="/images/commitment_grid_2.jpg" className="grid-img"/></div>
                            <div className="grid-item"><img src="/images/commitment_grid_3.jpg" className="grid-img"/></div>
                        </div>
