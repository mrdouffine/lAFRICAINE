...
export default function Home() {
    ...
    const navItems = [
        { label: 'CONTACT', img: `${WP_T}/Sename-1-r1xe376lzrcchn224s6ugdn9nebdbydw2xb63g4hl0.png`, href: '/contact' },
        { label: 'BIOGRAPHY', img: `${WP_T}/SSS-r1xe32hf1l5wvl8vw85plwtyogyj9gv8ea1qp2bgg4.png`, href: '/bio' },
        { label: 'EDITION', img: `${WP_T}/Sename-2-r1xe3a04k9g7ggxyobeq5uxnfjxgz1p33b9mja0b2c.png`, href: '/edition' },
        { label: 'LECTURES', img: `${WP_T}/Sename-4-r1xe3bvsxxis3ov8dc7zaugkmbo7efwjrkklhtxipw.png`, href: '/lectures' },
        { label: 'CONSULTING', img: `${WP_T}/Sename-5-r1xe33f98f77777iqqkc6elf9utwh5yyqep86ca29w.png`, href: '/consulting' },
        { label: 'ACADEMIC', img: `${WP_T}/Sename-6-r1xe31jkur4mjza91pr31f2i33361rri25e97scumc.png`, href: '/academic' },
        { label: 'AUDIO', img: `${WP_T}/Sename-Audio-r1xe32hf1l5wvl8vw85plwtyogyj9gv8ea1qp2bgg4.png`, href: '/audio' },
        { label: 'VIDEO', img: `${WP_T}/Sename-8-r1xe34d3f98hit65l8yyqwcvv8p9ov2p2jcpnm8o3o.png`, href: '/video' },
        { label: 'PHOTO', img: `${WP_T}/Sename-9-r1xe392adfex4uzbtt03ld66u623rclcr6m5201p8k.png`, href: '/photo' },
        { label: 'HubCity', img: `${WP_T}/HUBCITY-r1xe3ctn4rk2fatv7umlvc817pjkm50a3p82z3w4jo.png`, href: 'https://hubcity.africa/', external: true },
        { label: 'CURATING', img: `${WP_T}/Sename-10-r1xe30lqnx3c8dbm77cggxb1hp7su2nrq0qrqie8sk.png`, href: '/curating' },
        { label: 'TECH', img: `${WP_T}/Sename-11-r1xe2yq2a90rl5eci6j7bxs4axh2eogb1rfsryh150.png`, href: '/tech' },
        { label: 'LESSONS', img: `${WP_T}/Sename-7-r1xe3a04k9g7ggxyobeq5uxnfjxgz1p33b9mja0b2c.png`, href: '/lessons' },
        { label: 'ARCHITECTURE', img: `${WP_T}/Sename-13-r1xe31jkur4mjza91pr31f2i33361rri25e97scumc.png`, href: '/architecture' },
        { label: 'PUBLICATION', img: `${WP_T}/Sename-14-r1xe3bvsxxis3ov8dc7zaugkmbo7efwjrkklhtxipw.png`, href: '/publications' },
        { label: 'QUOTES', img: `${WP_T}/Sename-15-r1xe392adfex4uzbtt03ld66u623rclcr6m5201p8k.png`, href: '/quotes' },
        { label: 'COLLABORATION', img: `${WP_T}/60-r1xe2ng008lbptuqc1noi0ml6b0nub7j07lz0mxr7o.jpg`, href: '/collaborations' },
        { label: 'HONOR', img: `${WP_T}/Sename-17-r1xe384g6ldmt90ozalh0veq8s6qjnhmf1ynkq33es.png`, href: '/honor' },
        { label: 'PRESS', img: `${WP_T}/Sename-18-r1xe392adfex4uzbtt03ld66u623rclcr6m5201p8k.png`, href: '/press' },
        { label: 'COMMITMENT', img: `${WP_T}/Sename-12-r1xe32hf1l5wvl8vw85plwtyogyj9gv8ea1qp2bgg4.png`, href: '/commitment' },
        { label: 'INVEST', img: `${WP_T}/Sename-19-r1xe2xs83ezh9jfpno4krg0npjlp6zckpmsbaoifb8.png`, href: '/invest' },
        { label: 'BOARD', img: `${WP_T}/21-r1xe376lzrcchn224s6ugdn9nebdbydw2xb63g4hl0.png`, href: '/board' },
    ];
